                    ...
                    <tbody>
                        {allflight && allflight.map((flight, index) => (
                            <tr key={index} className="border-b hover:bg-gray-50">
                                <td className="border border-gray-300 p-2">{flight.flight_name}</td>
                                <td className="border border-gray-300 p-2">{flight.flight_no}</td>
                                <td className="border border-gray-300 p-2">{flight.from_location}</td>
                                <td className="border border-gray-300 p-2">{flight.to_location}</td>
                                <td className="border border-gray-300 p-2">{flight.start_time}</td>
                                <td className="border border-gray-300 p-2">{flight.end_time}</td>
                                <td className="border border-gray-300 p-2">{flight.price}</td>
                                <td className="border border-gray-300 p-2">{flight.seat_capacity}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
