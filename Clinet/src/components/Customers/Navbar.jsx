  ...
  return (
    <nav className="bg-slate-400 p-4">
      <div className="flex justify-between items-center">
        {/* Left side: SB Flight */}
        <a href='/homepage' className="text-white text-lg font-semibold">
          SB Flight
        </a>
        ...
        <div className="hidden md:flex space-x-4">
          ...
          <button onClick={handlebooking} className="text-white hover:text-gray-400">Booking</button>
          <button onClick={handleprofile} className="text-white hover:text-gray-400">Profile</button>
