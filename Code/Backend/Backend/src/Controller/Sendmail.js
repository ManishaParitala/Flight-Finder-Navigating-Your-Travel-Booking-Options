...
export const SendOrderConfirm = async (toEmail, orderDetails) => {
...
export const SendFlightCancelled = async (toEmail, bookingDetails) => {
  // Create a transporter using Gmail
  const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
    ...
    html: `
        <div style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;">
          ...
          <div style="background-color: white; padding: 20px; margin-top: 10px; border-radius: 5px;">
            ...
            <ul>
              ${bookingDetails.booking.map((passenger) => `
