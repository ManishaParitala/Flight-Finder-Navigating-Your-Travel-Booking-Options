                ...
                <table className="min-w-full border-collapse border border-pink-900">
                    <thead>
                        <tr className="bg-emerald-500">
                            <th className="border border-blue-300 p-2">Flight Name</th>
                            <th className="border border-blue-300 p-2">Flight No</th>
                            <th className="border border-blue-300 p-2">Start Location</th>
                            <th className="border border-blue-300 p-2">End Location</th>
                            <th className="border border-blue-300 p-2">Start Time</th>
                            <th className="border border-blue-300 p-2">End Time</th>
                            <th className="border border-blue-300 p-2">seat capacity </th>
                            <th className="border border-blue-300 p-2">Available Seats</th>
                        </tr>
                    </thead>
                    <tbody>
                        {allflight && allflight.map((flight, index) => (
                            <tr key={index} className="border-b hover:bg-yellow-200">
