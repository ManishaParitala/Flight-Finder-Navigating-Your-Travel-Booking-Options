  ...
  return (
    <nav className="bg-red-500 p-4">
      <div className="flex justify-between items-center">
        {/* Left side: SB Flight */}
        <a href='/homepage' className="text-white text-4xl text-lg font-semibold">
          Flight Finder
        </a>

        {/* Right side: Logout, Booking, Profile */}
        <div className="hidden md:flex space-x-4">
          <a href='/homepage' className="text-white text-2xl hover:text-blue-300">
            Home
          </a>
          <button onClick={handlebooking} className="text-white text-2xl hover:text-blue-300">Booking</button>
          <button onClick={handleprofile} className="text-white text-2xl hover:text-blue-300">Profile</button>
          <button onClick={handleLogout} className="text-white text-2xl hover:text-blue-300">Logout</button>
      ...
      {/* notificaton */}
      {shownotification &&
        <div className="min-w-64 min-h-20 bg-slate-100 rounded-xl fixed top-16 right-7">
