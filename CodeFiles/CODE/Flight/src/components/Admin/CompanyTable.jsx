              ...
              filteredCompanies && filteredCompanies.map((company, index) => (
                <tr key={index} className="border-b hover:bg-gray-50">
                  <td className="border border-gray-300 p-2">
                    <img src={`http://192.168.1.130:4000/uploads/company/${company.photo}`} alt={company.name} className="w-24 h-24 object-cover rounded-full" />
                  </td>
                  ...
                  <td className="border border-gray-300 p-2">{company.address}</td>
                  <td className="border border-gray-300 p-2">
